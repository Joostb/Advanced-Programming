...
f3 :: IO Student
f3 = (\ _ . \fname. \ _ . \lname. \ _ . \snum.
		 ( {fname = rmNL fname, lname = rmNL lname, snum = snum} ))
		 <$>  (write "Your first name please: ") <*>read <*>(write "Your last name please: ") <*> read <*> (write "Your student nmber please: ") <*>read
